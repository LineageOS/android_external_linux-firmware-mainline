...
def main():
	...
	with TemporaryDirectory() as temp_dir:
		...
		with ANDROID_BP_PATH.open("w") as f:
			...
			# TODO: Phony has a bug with LOCAL_ADDITIONAL_DEPENDENCIES and file names with spaces,
			# so fuck you you get a copy of Android.bp on your device
			f.write(f'\n')
			f.write(f'prebuilt_etc {{\n')
			f.write(f'    name: "linux_firmware_all",\n')
			f.write(f'    src: "Android.bp",\n')
