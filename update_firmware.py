...
AOSP_LINUX_FIRMWARE_OVERRIDE: Dict[Path, str] = {
	...
	in {
		...
		# Intel BE200 Wireless MAC
		'iwlwifi-gl-c0-fm-c0-97': [
			'iwlwifi-gl-c0-fm-c0-97.ucode',
		],

		# # Intel BE200 Wireless MAC (PNVM file)
		...
		# Intel Xe GPU firmware for PTL-based platforms
		'xe_ptl': [
			'xe/ptl_guc_70.bin',
			'xe/ptl_huc.bin',
		],
